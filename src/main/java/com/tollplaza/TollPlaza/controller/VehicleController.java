...
//	@GetMapping("/getVehiclesByDate/{date}")
//	public ResponseEntity<List<Vehicles>> getVehiclesByDate(@PathVariable String date) {
//	    List<Vehicles> vehicles = vehicleService.getVehiclesByDate(date);
//	    if (vehicles.isEmpty()) {
